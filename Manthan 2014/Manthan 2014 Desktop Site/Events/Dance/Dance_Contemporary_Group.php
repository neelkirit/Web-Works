...
var event_subcategory = "Contemporary Group";
var description = " Redefine the parameters of contemporary performance. Designed as an intensive festival, this unique and existing event is envisaged to give high quality Indian innovation in Indian dance and support the development of vibrant new artistic work.";
var entry_fee = "Rs 500";
var prize_money = "First Prize = Rs 7000 <br> Second Prize = Rs 3500";

var event_coordinators = "VIVEK.C : 8861262996 <br> RASHMI N : 8861615887<br> KRITHIKA : 9740246126";


var event_rules = "Minimum:6 people;Maximum:10+2 people;Time limit:5+1 min;Any prop can be used, which is not dangerous on stage(No fireworks);Any light arrangements required should be mentioned before;Teams should bring their sound tracks in a pen drive(one extra);We are not responsible for mistakes in your sound tracks";
var event_image = "Dance.jpg";

var day_and_time = "3pm(Day 1)";
