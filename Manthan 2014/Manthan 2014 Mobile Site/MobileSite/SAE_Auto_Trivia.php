<?php
 ...
 var event_subcategory = "Auto Trivia";
 var description = "5 Rounds of Quiz covering General Topics";
 var entry_fee = "Rs 40 per team";
 var day_and_time = "Day 2,@ 10am";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Tushar Sinha  : 8884597407<br>Ashish Ranjhan Jha : 8123441422";
 
 
 var event_rules = "TEAM SIZE :2 members per team;PRELIMINARY ROUND : Top 6 teams will qualify after prelims.;JUDGING CRITERIA : Points Based . Eliminations starts after 3 rounds. Quiz master’s Decision will be final .";
