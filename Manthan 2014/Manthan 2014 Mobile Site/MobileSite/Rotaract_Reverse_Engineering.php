 ...
 var event_category = "Rotaract";
 var event_subcategory = "Reverse Engineering";
 var description = "A platform to expose your Mechanical skills in dismantling, handling & analysing the machine parts at the quickest.";
 var entry_fee = "Rs 60 per team";
  var day_and_time = "Day 2,@ 1pm";
 var prize_money = "First Prize = Rs 3000 <br> Second Prize = Rs 1500";
 
 var event_coordinators = "VIKRAM : 81058 45364<br>GAURAV B : 77605 34450<br>SHUBHAM : 72040 36404<br>ANUJ : 74116 17734";
 
 
 var event_rules = "A team of 2 members.;First round – MCQ’s on AUTOMOBILES;Second round- Dismantle the given mechanical device & re-assemble it within specified time.;The device may be 2-STROKE IC ENGINE or TWO WHEELER GEAR BOX or MULTI CYLINDER ENGINE CARBURETOR.;Tools will be provided.";
 var event_image = "Rotaract.jpg";
