 ...
 var event_subcategory = "One Sip Ahead";
 var description = "Keep drinking till you can no longer drink. Be the fastest and be the winner.";
 var entry_fee = "Rs 30";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Amarjeeth Singh : 8197605258<br>Himanshu : 8095840065";
 
 
 var event_rules = "Each person will be provided with the glass half filled with cold drink and one big straw in it.;There will be some estimated time limits.; Whosoever in the group will drink the cold drink fast will be the winner.;There will be minute holes in the straw.";
