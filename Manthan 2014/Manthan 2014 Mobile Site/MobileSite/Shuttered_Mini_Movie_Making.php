 ...
 var event_subcategory = "Mini Movie Making";
 var description = " Let's see who is the next Spielberg.This event is a perfect platform for college going students who have interest in short film making. ";
 var entry_fee = "Rs 50 per team";
 var day_and_time = "Day 1&2,@ 12pm";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = " Abhishek: 81473 52744 <br> Somnath: 74119 73259 ";
 
 
 var event_rules = "Contestants will participate with a short film made by them.;They can use their smartphones, camcorders etc. The film should have clear picture quality and audible sound quality. ;Language - English, Hindi , Kannada (with Eng. subtitles );Movie length - 3 to 10 minutes ;We'll shortlist the films which will be played (using projectors);We can also raise some money by advertisements like displaying the sponsor’s name as movie-partner in short films.;Prizes   a) Best Screenplay: ₹ 1000;b) Best Direction: ₹ 1000;No Plagiarism";
