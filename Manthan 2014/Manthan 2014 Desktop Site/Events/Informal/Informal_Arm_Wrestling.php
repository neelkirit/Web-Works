 ...
 var event_subcategory = "Arm Wrestling";
 var description = "You think you are strong ? Prove it to others by taking part in this event";
 var entry_fee = "Rs 30";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Srinivas : 9035170340<br>Manoj : 8880443064";
 
 
 var event_rules = "Elbow must be touched to the table/ground.;The hand position must be straight.;Never bend the wrist at any cost.;Once the competition begins one whose hand will be touched to the ground will be treated as the looser of the game.";
 var event_image = "Informal.jpg";
 
 var day_and_time = "2pm(Day 2)";
