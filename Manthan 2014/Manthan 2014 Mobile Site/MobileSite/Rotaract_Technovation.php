 ...
 var event_subcategory = "Technovation";
 var description = "An innovative technical event open for all branches. A platform for you to showcase your technical & application skills.";
 var entry_fee = "Rs 40 per head";
 var day_and_time = "Day 2,@ 1pm";
 var prize_money = "First Prize = Rs 4000 <br> Second Prize = Rs 2000";
 
 var event_coordinators = "Prithu Yash : 7760254421<br>Sonakshi Mushran : 9980262098<br>VEERESH BIDARALLI:   99451 36831";
 
 
 var event_rules = "A team of 2-3 members.;First round – APTITUDE TEST (common for all branches).;Second round- TECHNICAL TREASURE HUNT.;Third round- TECHNOMANIA.;Fourth round – ASSEMBLY.";
