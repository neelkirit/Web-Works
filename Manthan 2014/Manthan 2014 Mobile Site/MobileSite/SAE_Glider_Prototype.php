<?php
 ...
 var event_category = "S A E";
 var event_subcategory = "Glider Prototype";
 var description = "Team has to design a glider using Blasa wood with proper design parameters in 3 hours.";
 var entry_fee = "Rs 50 per person";
 var day_and_time = "Day 2,@ 11am and Day 3,@ 10am";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "SURENDRA S:  89710 39943<br>NANJUNDESHWARA :   81058 34694";
 
 
 var event_rules = "TEAM SIZE : 2-4 members per team ( UG students with  college ID);PRELIMINARY ROUND : MCQ Round (1 Hour ) based of general aviation and avionics topics.;JUDGING CRITERIA : Designing , Aesthetics , Time of flight ,  Horizontal Displacement of the Glider.; Organizer’s Decision will be final";
 var event_image = "SAE.jpg";
