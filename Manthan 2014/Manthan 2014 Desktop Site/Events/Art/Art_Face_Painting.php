 ...
 var event_subcategory = "Face Painting";
 var description = "“Color your imagination, bring it to Real World”. Nothing feels better than colors. Add colors to your strokes!";
 var entry_fee = "Rs 50";
 var prize_money = "First Prize = Rs 1500 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Utkarsh : 8861620947<br>Manisha : 9955003227";
 
 
 var event_rules = "Individual event;Duration:2.5 hours;Topic: On spot;Brushes & paints to be brought by participants.;No crayons, color pencils, sketch pens to be used";
