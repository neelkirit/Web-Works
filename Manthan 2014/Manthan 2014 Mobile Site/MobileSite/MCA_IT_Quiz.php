 ...
 var event_subcategory = "IT Quiz";
 var description = "A Quiz is a form of game or mind sport in which the players attempt to answer questions correctly.";
 var entry_fee = "Rs 150 per team";
 var day_and_time = "Day 2,@ 10am";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Mohith : 7760813228<br>Shashank : 9900575846<br>Shruthi D N:	97413 57571";
 
 
 var event_rules = "No. of participants Two(2) per team.;1st Round: Prelims Round (Puzzling of Hints).; 2nd Round: You pick we Ask.; 3rd Round: Rapid fire on Audio Visual";
