 ...
 var event_subcategory = "Eastern/semi classical solo (vocals)";
 var description = " Found yourself crooning to those popular Bollywood tunes. If your friends think you’re good, We’re ready to  provide you the perfect stage.";
 var entry_fee = "Rs 50";
 var prize_money = "First Prize = Rs 2000 <br> Second Prize = Rs 1000";
 
 var event_coordinators = "Anusha : 7411950260<br>Aishwarya  S : 9742331699";
 
 
 var event_rules = "Duration:5+1 minParticipants can sing Film Hits, Bhavageethe, Bhajans, Gazals & Devaranama;Karaoke allowed.So participants have to get their song in a CD or a pen drive;Shruthi box will not be provided;One accompanist allowed";
